...
wasteLogo.src = "img/wasteLogo.png";
...
var intro = new Image();
intro.src = "img/gameStartPanel.png";
...
html5icon.src = "img/html5Logo.png"
html5icon.style.position = "absolute";

var fullScreenIcon = new Image();
fullScreenIcon.src = "img/fullscreen_ON.png"
...
function onReady()
{
	...
	loader = new PIXI.AssetLoader(["img/floor.json", "img/ActionAssets.json",  "img/hudAssets.json",  "img/vignette.png", "img/EMP.png"])
...
function loaderUpdate()
{
	...
	if(round == 0)
	{
		loaderText.src = "img/gameLoading01.png"
	}
	else if(round == 1)
	{
		loaderText.src = "img/gameLoading02.png"
	}
	else if(round == 2)
	{
		loaderText.src = "img/gameLoading03.png"
	}
	else if(round == 3)
	{
		loaderText.src = "img/gameLoading04.png"
	}
